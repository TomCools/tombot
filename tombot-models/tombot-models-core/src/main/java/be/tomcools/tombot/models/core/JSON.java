...
import be.tomcools.tombot.models.core.tools.custom.FacebookMessageAttachementDeserializer;
import be.tomcools.tombot.models.core.tools.custom.FacebookNlpDeserializer;
...
public class JSON {
    private static Gson GSON = new GsonBuilder()
            ...
            .registerTypeAdapter(FacebookNlp.class, new FacebookNlpDeserializer())
            .create();
